...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/de568124dcc53bae1081cf910ed54aba.html").path();
...
/*!***************************!*\
  !*** ./src/my-command.js ***!
  \***************************/
/*! exports provided: default, onSelectionChanged, showMessage, onShutdown */
...
var Style = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.Style;
var symbolMaster = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.symbolMaster;
var document = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.getSelectedDocument();
var deviceKey = ['desktop (2000)', 'desktop (1440)', 'desktop (1200)', 'desktop', 'tablet', 'mobile'];
var themeKey = ['light', 'dark'];
var sizeKey = ['small', 'medium', 'large'];
var webviewIdentifier = 'my-plugin.webview';
var doc = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.getSelectedDocument();
var selectedLayers;
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (selectedCount === 0) {
    sketch__WEBPACK_IMPORTED_MODULE_3___default.a.UI.message('No layers are selected');
  } else if (selectedCount > 1) {
    sketch__WEBPACK_IMPORTED_MODULE_3___default.a.UI.message('Please select a single layer');
  } else {
  ...
  webContents.on('dropdownChanged', function (symbolString) {
    //replace the symbol
    selectedLayers = doc.selectedLayers;
    ...
    webContents.executeJavaScript("loadDropdowns(".concat(JSON.stringify(dropdownArray), ")")).catch(console.error);
    sketch__WEBPACK_IMPORTED_MODULE_3___default.a.UI.message(symbolString);
  });
